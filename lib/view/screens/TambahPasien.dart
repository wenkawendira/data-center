...
class _TambahPasienScreen extends StatefulWidget {
  @override
  __TambahPasienScreenState createState() => __TambahPasienScreenState();
}

class __TambahPasienScreenState extends State<_TambahPasienScreen> {
